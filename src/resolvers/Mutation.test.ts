...
describe('User suit', () => {
  ...
  describe('Create an user', () => {
    it('Create user successfully', async () => {
      ...
      //THEN
      const userCreated = await Mutation.createUser(
        null,
        {
          data: {
            name: 'name',
  ...
  describe('Udpate an user', () => {
    it('Update user successfully', async () => {
      ...
      //THEN
      const userUpdated = await Mutation.updateUser(
        null,
        {
          data: {
            id: '12345',
  ...
  describe('Delete an user', () => {
    it('Delete user successfully', async () => {
      ...
      const userDeleted = await Mutation.deleteUser(
        null,
        {
          id: '12345',
        },
    ...
    it('Delete user unsuccessfully', async () => {
      ...
      let userDeleted
      try {
        userDeleted = await Mutation.deleteUser(
          null,
          {
            id: '12345',
          },
